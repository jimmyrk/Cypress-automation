...
describe('Working with input', () => {
    it('visit the website', () => {
        ...
        // Check alert error
        cy.get('.notice > h2').should('have.text', 'We couldn’t find an account matching the username and password you entered. Please check your username and password and try again.');
    });
});
